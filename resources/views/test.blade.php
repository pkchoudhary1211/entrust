...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="{{asset('testAsset/images/logo.svg')}}" alt="alternative"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="{{asset('testAsset/images/header-teamwork.svg')}}" alt="alternative">
    ...
    <!-- Scripts -->
    <script src="{{asset('testAsset/js/jquery.min.js')}}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{asset('testAsset/js/popper.min.js')}}"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="{{asset('testAsset/js/bootstrap.min.js')}}"></script> <!-- Bootstrap framework -->
    <script src="{{asset('testAsset/js/jquery.easing.min.js')}}"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="{{asset('testAsset/js/swiper.min.js')}}"></script> <!-- Swiper for image and text sliders -->
    <script src="{{asset('testAsset/js/jquery.magnific-popup.js')}}"></script> <!-- Magnific Popup for lightboxes -->
    <script src="{{asset('testAsset/js/validator.min.js')}}"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="{{asset('testAsset/js/scripts.js')}}"></script> <!-- Custom scripts -->
</body>
</html>